    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-4">
        ...
        {:else}
          ...
          <a
            href="/notifications"
            class="relative hover:opacity-80 transition p-2"
            title="Notifications"
          ...
          >
            ...
            {#if unread > 0}
              <span
                class="absolute -top-1 -right-1 bg-amber-400 text-primary text-xs font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1 shadow-xs"
              >
            ...
            {#if createOpen}
              ...
              >
                ...
                <a href="/brews/new" class="dropdown-item" role="menuitem">
                  {#if isOolong}<Icon name="droplet" />{:else}<Icon
                      name="coffee"
                    />{/if}
                ...
                <div class="dropdown-divider">
                  <p
                    class="px-4 pt-1 text-xs font-semibold uppercase tracking-wider text-faint"
                  >
                    Add
                  </p>
                </div>
          ...
          <div class="relative" data-menu-root>
            ...
            {#if userOpen}
              <div class="dropdown-menu" class:is-open={userOpen} role="menu">
                ...
                {#if isOolong}
                  <a href="/my-tea" class="dropdown-item" role="menuitem"
                    >My Tea</a
                  >
                {:else}
                  <a href="/explore" class="dropdown-item" role="menuitem"
                    >Explore</a
                  >
                  <a href="/my-coffee" class="dropdown-item" role="menuitem"
                    >My Coffee</a
                  >
                  <a href="/recipes" class="dropdown-item" role="menuitem"
                    >Recipes</a
                  >
                {/if}
                ...
                {#if s.isModerator}
                  ...
                  <a
                    href="/_mod"
                    class="dropdown-item dropdown-item-mod"
                    role="menuitem"
                  >
                    <Icon
                      name="shieldCheck"
