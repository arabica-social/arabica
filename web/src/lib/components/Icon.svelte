<script lang="ts" module>
  ...
  export const iconPaths = {
    ...
    teapot:
      '<circle cx="12" cy="5" r="0.75"></circle><path d="M7 9c1-2 3-3 5-3s4 1 5 3"></path><path d="M6 10h12"></path><path d="M6 10c0 6 2 10 6 10s6-4 6-10"></path><path d="M6 12c-2 0-3-1-3-3"></path><path d="M18 12c2 0 3 1 3 3s-1 3-3 3"></path>',
    scale:
    ...
    sprout:
      '<path d="M8.5 2h7"></path><path d="M14 2v6a2 2 0 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2"></path><path d="M6.453 15h11.094"></path>',
