	...
	return []handlers.EntityRouteBundle{
		{
			...
			JSONView:      h.HandleTeaViewJSON,
			Backlinks:     h.HandleTeaBacklinks,
			JSONBacklinks: h.HandleTeaBacklinksJSON,
		},
		{
			...
			JSONView:      h.HandleOolongVendorViewJSON,
			Backlinks:     h.HandleOolongVendorBacklinks,
			JSONBacklinks: h.HandleOolongVendorBacklinksJSON,
		...
		},
		{
			...
			JSONView:      h.HandleOolongVesselViewJSON,
			Backlinks:     h.HandleOolongVesselBacklinks,
			JSONBacklinks: h.HandleOolongVesselBacklinksJSON,
		...
		},
		{
			...
			JSONView:      h.HandleOolongInfuserViewJSON,
			Backlinks:     h.HandleOolongInfuserBacklinks,
			JSONBacklinks: h.HandleOolongInfuserBacklinksJSON,
		...
		},
		{
			...
			JSONView:      h.HandleOolongBrewViewJSON,
			Backlinks:     h.HandleOolongBrewBacklinks,
			JSONBacklinks: h.HandleOolongBrewBacklinksJSON,
