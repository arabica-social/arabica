...
func TestButtonComponents(t *testing.T) {
	...
	t.Run("PrimaryButton", func(t *testing.T) {
		...
		html := renderToString(t, ctx, PrimaryButton(props))
	...
	t.Run("SecondaryButton", func(t *testing.T) {
		...
		html := renderToString(t, ctx, SecondaryButton(props))
	...
	t.Run("BackButton", func(t *testing.T) {
		...
		html := renderToString(t, ctx, BackButton(props))

		if !strings.Contains(html, "data-back-button") {
			t.Error("Expected data-back-button attribute")
		}
		if !strings.Contains(html, `data-fallback="/brews"`) {
			t.Error("Expected data-fallback attribute")
		}
...
func TestFormComponents(t *testing.T) {
	...
	t.Run("TextInput", func(t *testing.T) {
		...
		html := renderToString(t, ctx, TextInput(props))
	...
	t.Run("NumberInput", func(t *testing.T) {
		...
		html := renderToString(t, ctx, NumberInput(props))
	...
	t.Run("TextArea", func(t *testing.T) {
		...
		html := renderToString(t, ctx, TextArea(props))
	...
	t.Run("Select", func(t *testing.T) {
		...
		html := renderToString(t, ctx, Select(props))
...
func TestModalComponents(t *testing.T) {
	...
	t.Run("Modal with static title", func(t *testing.T) {
		...
		html := renderToString(t, ctx, Modal(props, content))
...
func TestCardComponent(t *testing.T) {
	...
	t.Run("Basic card", func(t *testing.T) {
		...
		html := renderToString(t, ctx, Card(props, content))
