<script lang="ts">
  ...
  async function handleSubmit(event: SubmitEvent) {
    ...
    if (!target.contains(eventTarget) || !eventTarget.matches('form[data-svelte-comment-form]')) {
      return;
    }
    ...
    const localStatus = form.querySelector<HTMLElement>('[data-comment-form-status]');
