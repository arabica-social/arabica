...
<div class="max-w-3xl mx-auto">
  <div class="flex items-center gap-3 mb-8">
    ...
    <span
      class="text-sm bg-amber-400 text-brown-900 px-3 py-1 rounded-md font-semibold shadow-sm"
      >ALPHA</span
    >
  </div>
  ...
  <div class="prose prose-lg max-w-none space-y-6">
    <section>
      <h2 class="text-2xl font-semibold text-brown-900 mb-4">
        Your Coffee Journey, Your Data
      </h2>
      <p class="text-brown-800 leading-relaxed">
        Arabica is a coffee brew tracking application built on the AT Protocol,
        a decentralized social networking protocol. Unlike traditional apps
        where your data is locked in a company's database, Arabica stores your
        brew logs, coffee beans, and equipment information in <strong
          >your own Personal Data Server (PDS)</strong
        >.
      </p>
    </section>

    <section
      class="bg-gradient-to-br from-brown-100 to-brown-200 p-6 rounded-xl border border-brown-300"
    >
      ...
      <ul class="list-disc list-inside space-y-2 text-brown-800">
        ...
        <li>
          <strong>Privacy by design</strong> - You control who sees your brews
        </li>
        <li>
          <strong>Open protocol</strong> - Built on the AT Protocol, the same technology
          powering Bluesky
        </li>
      </ul>
    </section>
      ...
      <div class="grid md:grid-cols-2 gap-4">
        ...
        >
          ...
          <p class="text-brown-700 text-sm">
            Log every detail: beans, grind size, water temp, brew time, and
            tasting notes
          </p>
        </div>
        <div
        ...
        >
          ...
          <p class="text-brown-700 text-sm">
            Keep track of your grinders, brewers, beans, and roasters
          </p>
        </div>
        <div
          class="bg-gradient-to-br from-brown-50 to-brown-100 border border-brown-200 p-4 rounded-lg shadow-md"
        >
          ...
          <p class="text-brown-700 text-sm">
            Share your best brews with the community (coming soon: likes and
            comments!)
          </p>
        </div>
        <div
    ...
    >
      ...
      <p class="text-brown-800 mb-4">
        ...
        Protocol. The easiest way is to create a Bluesky account at <a
          ...
          target="_blank"
          rel="noopener noreferrer">bsky.app</a
        >.
      </p>
      <p class="text-brown-800">
        Once you have an account, simply log in with your handle (e.g.,
        yourname.bsky.social) and start tracking your brews!
      </p>
    </section>
