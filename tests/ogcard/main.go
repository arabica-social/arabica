	...
	cases := []testCase{
		...
		{"/tmp/og-brew-pourover.png", func() (*ogcard.Card, error) {
			return ogcard.DrawBrewCard(&arabica.Brew{
				...
				BrewerObj:  &arabica.Brewer{Name: "V60", BrewerType: "pourover"},
				GrinderObj: &arabica.Grinder{Name: "Comandante C40"},
				Pours: []*arabica.Pour{
					{WaterAmount: 50, TimeSeconds: 0},
					{WaterAmount: 100, TimeSeconds: 45},
					{WaterAmount: 100, TimeSeconds: 75},
				},
				PouroverParams: &arabica.PouroverParams{
		...
		{"/tmp/og-brew-espresso.png", func() (*ogcard.Card, error) {
			return ogcard.DrawBrewCard(&arabica.Brew{
				...
				BrewerObj:  &arabica.Brewer{Name: "Linea Mini", BrewerType: "espresso"},
				GrinderObj: &arabica.Grinder{Name: "Niche Zero"},
				EspressoParams: &arabica.EspressoParams{
		...
		{"/tmp/og-brew-immersion.png", func() (*ogcard.Card, error) {
			return ogcard.DrawBrewCard(&arabica.Brew{
				...
				BrewerObj:    &arabica.Brewer{Name: "French Press", BrewerType: "immersion"},
				GrinderObj:   &arabica.Grinder{Name: "Timemore C2"},
		...
		{"/tmp/og-brew-long.png", func() (*ogcard.Card, error) {
			return ogcard.DrawBrewCard(&arabica.Brew{
				...
				Bean: &arabica.Bean{
					...
					Roaster: &arabica.Roaster{Name: "Manhattan Coffee Roasters"},
				},
				BrewerObj:    &arabica.Brewer{Name: "Chemex", BrewerType: "pourover"},
